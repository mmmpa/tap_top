...
class Line {
  ...
  render () {
    ...
    return <g id={this.props.data.name + this.props.data.id} {...{ onMouseOver }} key={this.props.data.name}>{line.map((d, i)=> {
      ...
      let re = pre
        ? <line {...now} style={`stroke:${this.props.data.color};stroke-width:1`}/>
        : null
