...
class Watcher {
  ...
  initialize () {
    ...
    let totalCPU = new PrettySimpleChart('totalCPU', gen({
      name: 'totalCPU',
      data: CPUList,
    })).render()

    let totalMemory = new PrettySimpleChart('totalMemory', gen({
      name: 'totalMemory',
      data: memoryList,
    })).render()

    let CPUGraph = new PrettySimpleChart('CPUGraph', gen({
      name: 'PerCPU',
      data: pickRow('%CPU', processList),
      stack: false
    })).render()

    let memoryGraph = new PrettySimpleChart('memoryGraph', gen({
      name: 'PerMemory',
